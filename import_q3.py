"""
Auto-generated script to import the uploaded Q3 data into a MySQL table.
Replace the MySQL connection placeholders with your credentials, then run:

    python import_Q3_to_mysql.py

This script will:
 - create a table named "q3_data" (if not exists) inferred from the Excel headers,
 - insert all rows from the file "Q3 Dataset.csv" (sheet: (n/a)),
 - print progress.
...
FILE_PATH = r"C:\Users\dell\OneDrive\Dokumente\Data Analytics\Data Analytics\MovieDB.xlsx"
SHEET_NAME = None
TABLE_NAME = "q3_data"
...
CREATE_STMT = r"""CREATE TABLE IF NOT EXISTS `q3_data` (
  ...
  `OtherInfo` TEXT,
  `Date` VARCHAR(50),
  `DirectorsRating` VARCHAR(50),
  `WritersRating` VARCHAR(50),
  `TotalFollowers` VARCHAR(50),
  `Revenue` VARCHAR(50)
